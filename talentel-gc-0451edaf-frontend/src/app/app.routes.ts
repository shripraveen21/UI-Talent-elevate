...
export const routes: Routes = [
  ...
  { path: 'updateTopics/:techStackId', component: UpdateTopicsComponent, canActivate: [authGuard], data: { roles: ['CapabilityLeader']} },
  { path: 'delivery-manager-dashboard', component: DeliveryManagerDashboardComponent, canActivate: [authGuard], data: { roles: ['DeliveryManager','DeliveryLeader','ProductManager'] } },
  ...
  {
    path: 'collab-tech-stacks',
    component: CollabTechStacksComponent,
    canActivate: [CollabGuard],
    data: { permission: 'topics' }
  },
  {
    path: 'collab-topics/:techStackId',
  ...
  {
    path: 'handson-result/:id',
    loadComponent: () => import('./components/handson-result/handson-result.component').then(m => m.HandsonResultComponent)
  },
